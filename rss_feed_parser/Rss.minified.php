...
class Rss {
    ...
    private function getFile($url) {
        ...
        if (function_exists('curl_init')) {
            ...
            throw new Exception("I'm sorry but there's simply no way how I can load the feed..."); return $feed;
    }
        ...
        if ($this->item === TRUE) {
            switch ($this->tag) {
                case "TITLE": $this->title .= $data;
                    break;
                case "CATEGORY": $this->category .= $data;
                    break;
                case "DESCRIPTION": $this->description .= $data;
                    break;
                case "LINK": $this->link .= $data;
                    break;
                case "PUBDATE": $this->pubDate .= $data;
                    break;
            }
        }
    }
