...
abstract class BaseUser extends CActiveRecord {
    ...
    public function rules() {
        return array(
            //FirstName, LastName, UserName, InsertedDate, UpdatedDate, 
            array('Email, Password, BirthDate, Status', 'required'),
            ...
            array('UserId, UserType, Email, Password,  BirthDate, AccountVerified, InsertedDate, UpdatedDate, Status', 'safe', 'on'=>'search'),
        );
    }

    public function relations() {
        return array(
            'userDetails' => array(self::HAS_MANY, 'UserDetails', 'UserId'),
        );
    }
